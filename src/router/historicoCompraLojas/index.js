const passport = require('passport'),
     ...
     *       }
    **/
   router.post('/compraritem/cliente', passportJWT, require('./comprarItemLoja')());
    ...
    *       }
   **/
   router.post('/listar/cliente/historico/compra',passportJWT, require('./listarHistoricoCompra')());
