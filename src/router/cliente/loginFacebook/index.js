const { LoginClienteFacebook } = require('../../../service/api/cliente'),
    { resJsonP } = require('../../../utils');

/**
    * @api {post} http://93.188.164.122:3000/api/login/facebook Cliente Login Facebook
    * @apiSampleRequest http://93.188.164.122:3000/api/login/facebook
    * @apiName cliente_login_facebook
    * @apiGroup Login
    *
    * @apiVersion 1.0.0
    *
...
module.exports = () => (req, res) => {
    ...
    LoginClienteFacebook(req.body).then((result) => resJsonP(res, 200, result.status, result.objeto, result.mensagem))
        .catch((error) => {
